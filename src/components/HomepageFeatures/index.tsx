...
const FeatureList: FeatureItem[] = [
  ...
  },
  {
    ...
    description: (
      <>
        このwebサイトは2024年の東京都知事選に出馬する各候補者の公約とそれに対応する行動・実績、そして支援者について調査し、まとめます。発言は一切取り扱いません。支援者の定義は、特定候補者へ金銭もしくは労力の提供を行う組織・団体・個人あるいは、所属している or 支持表明があった政党とします。
      </>
    ),
  },
  {
    ...
    description: (
      <>
        私一人では追いきれない情報もあると思います。情報に偏りも生まれます。
